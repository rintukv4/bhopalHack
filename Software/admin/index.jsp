  ...
  <script>
	...
	//sensors value of node2
      ...
      var infoWindow = new google.maps.InfoWindow({
        content: '<h2>Node 1</h2>'+'<br><span>Flow rate : <%=flow1%> l/min </span>'+'<br><span>Turbidity : <%=tur%> NTU </span>'
      });
			...
			// Add marker
			  ...
			  var info = new google.maps.InfoWindow({
				content: '<h2>Node 2 </h2>'+'<br><span>Flow rate : <%=flow2%> L/min </span>' + '<br><span>Turbidity : - </span>'
			  });
